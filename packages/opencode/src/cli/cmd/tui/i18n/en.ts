export const dict: Record<string, string> = {
  ...
  "tui.marketplace.install.success": "Installed {0}, restart to take effect",
  "tui.marketplace.uninstall.title": "Uninstall plugin",
  "tui.marketplace.uninstall.confirm": "Uninstall {0}? The plugin directory will be removed; MCP/skills will stop working after restart.",
  "tui.marketplace.uninstall.failed": "Uninstall failed: {0}",
  "tui.marketplace.uninstall.not_installed": "{0} is not installed",
  "tui.marketplace.uninstall.success": "Uninstalled {0}, restart to fully take effect",
  "tui.marketplace.no_source": "This plugin has no source info",
