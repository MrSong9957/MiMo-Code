...
export const dict = {
  ...
  "tui.marketplace.install.start": "正在安装 {0}...",
  "tui.marketplace.install.failed": "安装失败：{0}",
  "tui.marketplace.install.skipped": "{0} 已安装，无需重复安装",
  "tui.marketplace.install.success": "已安装 {0}，重启后生效",
  "tui.marketplace.uninstall.title": "卸载插件",
  "tui.marketplace.uninstall.confirm": "确定卸载 {0}？该插件的目录将被删除，重启后 MCP/技能随之失效。",
  "tui.marketplace.uninstall.failed": "卸载失败：{0}",
  "tui.marketplace.uninstall.not_installed": "{0} 未安装",
  "tui.marketplace.uninstall.success": "已卸载 {0}，重启后完全生效",
  "tui.marketplace.no_source": "此插件无来源信息",
